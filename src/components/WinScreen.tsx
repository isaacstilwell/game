...
export default function WinScreen({ hull, shields, kills, onContinue }: Props) {
  return (
    <div style={{
      ...
      <MenuFrame>
        ...
        <div style={{
          ...
          <ReportRow label="STATUS"               value="SECURE" />
        </div>
        ...
        >
          ...
          <span style={{ fontSize: 15, letterSpacing: '4px', color: '#6dbdaf', lineHeight: '19px' }}>CONTINUE</span>
        </button>
